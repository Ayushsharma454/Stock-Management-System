...
import java.sql.*;
public class editseller extends JFrame implements ActionListener {
    ...
    public  void actionPerformed(ActionEvent ae) {
        if(ae.getSource()==b1)
        {
           try{
               ...
               rs=s.executeQuery("select * from sales where id="+id);
               rs.next();
        ...
        if(ae.getSource()==b2)
        {
            ...
            s.execute("update sales set pname='"+a+"',pquantity='"+b+"',price='"+c+"' where id="+id);
